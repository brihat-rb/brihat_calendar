/**
 * Solar NS to AD and AD to Solar NS Converter (part of Brihat Calendar)
...
const AD_MONTHS_NEP = ["जनवरी", "फेब्रुअरी", "मार्च", "अप्रिल", "मे", "जुन", "जुलाई", "अगस्ट", "सेप्टेम्बर", "ओक्टोबर", "नोभेम्बर", "डिसेम्बर"];
